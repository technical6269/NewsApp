...
export default function TextForm(props) {
  ...
  return (  
    ...
    <div className="container" style={{color: props.mode==='dark'?'white':'#042743' }} >
      <h1> {props.heading} </h1>
        <div className="mb-3">
         ...
         <button className="btn btn-primary mx-2" onClick={handleRemSpace} >Remove Extra Spaces</button>
    ...
    <div className="container my-3" style={{color: props.mode==='dark'?'white':'#042743' }}> 
      ...
      <p>{0.008 * text.split(" ").length } Minutes = {0.48 * text.split(" ").length} Seconds</p>
       <h2> Preview</h2>
